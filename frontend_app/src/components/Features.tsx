...
import { BarChart2, GitBranch, Search, Shield, Waypoints } from "lucide-react";
...
const CARDS = [
  ...
  //   id: "06",
  //   title: "Orchestrator",
  //   desc: "Coordinates state, checkpointing, retries, and agent boundaries so planning and execution stay isolated under pressure.",
  //   tag: "SYSTEM",
  //   accent: "#FACC15",
  //   metric: "Scoped control",
  //   layout: "",
  // },
];
      ...
      <div className="relative z-10 mx-auto max-w-[1320px]">
        <div className="mb-[clamp(44px,6vw,80px)] flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="max-w-[320px]">
            <p className="text-[14px] leading-[1.8] text-[#8E8EA8]">
              Decision-making, validation, and execution stay isolated on
              purpose. The visual system mirrors that separation with dedicated
              surfaces and status rails.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 grid gap-4 lg:grid-cols-[1.25fr_0.75fr]">
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {[
                ...
                <div key={title}>
                  ...
                  <div className="font-display mb-2 text-[18px] font-semibold text-white">
                    {title}
                  </div>
                  <div className="text-[13px] leading-[1.75] text-[#8E8EA8]">
                    {text}
                  </div>
                </div>
              ))}
          ...
          <div className="feat-card rounded-[26px] border border-[#1E1E32] bg-[#0A0A16]/88 p-6 opacity-0">
            <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.14em] text-[#2E2E4A]">
              routing discipline
            </div>
            <div className="font-display mb-4 text-[26px] font-bold leading-none text-white">
              No agent can decide and execute in the same pass.
            </div>
            <div className="text-[13px] leading-[1.8] text-[#8E8EA8]">
              The orchestration layer enforces a readable handoff between
              thesis, evidence, planning, and trade submission.
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-8 flex items-start justify-between gap-4">
                  <div
                    className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[#2E2E4A]"
                    style={{
                      color: card.accent,
                  ...
                  <div className="text-right">
                    <div className="font-mono text-[11px] text-[#2E2E4A]">
                      {card.id}
                    </div>
                    <div
                      className="mt-2 rounded-full border border-[#1E1E32] px-2.5 py-1 font-mono text-[9px] uppercase tracking-[0.12em]"
                ...
                <div className="mb-6">
                  <div className="font-display mb-3 text-[20px] font-bold tracking-[-0.03em] text-white">
                    {card.title}
                  </div>
                  <div className="text-[14px] leading-[1.8] text-[#8E8EA8]">
                    {card.desc}
                  </div>
                </div>
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-[#2E2E4A]">
                      signal
                    </span>
                    <span
